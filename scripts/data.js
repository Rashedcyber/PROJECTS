...
//   export { veg_data };
const renderVegCards = () => {
    const vegContainer = document.getElementById('veg-container');
    const vegetables = veg_data();
    console.log(vegetables); // Check the output here
    vegetables.forEach(veg => {
      ...
      card.innerHTML = `
        ...
        <div class="card-footer">
          <button class="button" onclick="addToCart('${veg.name}')">Add to Cart</button>
        </div>
      `;
  ...
  // Initialize and render the vegetable cards
  renderVegCards();
}